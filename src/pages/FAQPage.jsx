...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes! Earn 1 point for every ₹110 spent. Redeem points for free burgers, sides, and exclusive discounts.',
  },
];
...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0604]" ref={containerRef}>
      ...
      <section className="relative bg-gradient-to-br from-[#F07D14] via-[#E86C1B] to-[#B83A1B] text-white py-12 sm:py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-3 sm:px-4 lg:px-8" ref={headingRef}>
          <span className="inline-flex items-center gap-1.5 sm:gap-2 bg-white/20 backdrop-blur-sm border border-white/30 px-3 sm:px-4 py-1.5 sm:py-2.5 rounded-full text-xs sm:text-sm font-black mb-4 sm:mb-6 shadow-lg">
            <HelpCircle size={12} className="sm:size-16" />
            <span>SUPPORT</span>
          </span>
          <h1 className="font-fredoka text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black mb-3 sm:mb-6 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 mt-4 sm:mt-6 justify-center">
            ...
            <a href="/contact" className="inline-flex items-center gap-1.5 sm:gap-2 bg-white/15 backdrop-blur-sm border border-white/30 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-bold hover:bg-white/25 transition-all">
      ...
      <div className="mx-auto max-w-4xl px-3 sm:px-4 lg:px-8 py-8 sm:py-12 lg:py-16">
        {/* FAQ Items */}
        <div ref={listRef} className="space-y-3 sm:space-y-4">
          {faqs.map((item, i) => (
            <details
              key={i}
              className="faq-item group relative bg-gradient-to-br from-[#1E1612] to-[#16100D] rounded-xl sm:rounded-2xl border border-[#2A1F1A] transition-all duration-500 hover:border-[#F07D14]/60"
            >
              {/* Hover glow */}
              ...
              <summary className="flex items-center justify-between p-4 sm:p-5 lg:p-6 cursor-pointer list-none relative z-10">
                <div className="flex items-center gap-2.5 sm:gap-3 lg:gap-4 flex-1">
                  <span className="faq-icon text-xl sm:text-2xl lg:text-3xl flex-shrink-0">{item.icon}</span>
                  <div className="flex-1 min-w-0">
                    <span className="inline-block text-[10px] sm:text-xs font-black text-[#F07D14] uppercase tracking-wider mb-0.5 sm:mb-1">{item.category}</span>
                    <h3 className="font-fredoka font-bold text-white text-sm sm:text-base lg:text-lg truncate">{item.q}</h3>
                  </div>
                </div>
                <span className="ml-2 sm:ml-3 lg:ml-4 p-1.5 sm:p-2 rounded-full bg-[#F07D14]/15 text-[#F07D14] group-open:rotate-180 transition-transform duration-300 flex-shrink-0">
                  <ChevronDown size={16} className="sm:size-20" />
                </span>
              </summary>
              <div className="px-4 sm:px-5 lg:px-6 pb-4 sm:pb-5 text-[#C4B5AB] leading-relaxed relative z-10 pl-10 sm:pl-11 lg:pl-14">
                {item.a}
              </div>
            </details>
          ))}
        ...
        {/* Contact CTA */}
        <div className="mt-12 sm:mt-16 relative bg-gradient-to-br from-[#1E1612] via-[#1A1310] to-[#16100D] rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-10 text-center border-2 border-[#F07D14]/30 overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center justify-center w-12 sm:w-14 lg:w-16 h-12 sm:h-14 lg:h-16 bg-gradient-to-br from-[#F07D14] to-[#E86C1B] rounded-full mb-4 sm:mb-6 shadow-md sm:shadow-lg">
              <MessageCircle size={24} className="sm:size-28 lg:size-32" />
            </div>
            <h3 className="font-fredoka text-xl sm:text-2xl lg:text-3xl font-black text-white mb-2 sm:mb-3">Still have questions?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 sm:gap-3 px-5 sm:px-6 lg:px-8 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl bg-white/5 border-2 border-white/20 text-white font-black text-sm sm:text-base lg:text-lg hover:bg-white/10 hover:border-white/40 transition-all duration-300"
              >
